...
//val wrongByte : Byte =  1000 -> Byte가 표현할 수  있는 수 범위 보다 큰 수를 넣은 경우 에러발생
...
//val doubleNumber1 : Doulbe = 10 // 10과 10.0은 같지만 .을 찍어서 실수형이라는 것을 표현해야한다
...
// 팁
// - 타입을 선택할때 가장 작은 타입을 선택한다.
// - 실제로는 대부분 그냥 Int, Double를 사용합니다.

// 변수명
val val : Int = 10 -> 코틀린에서 선점해서 사용하고 있는 키워드는 변수명으로 사용할수 없다.